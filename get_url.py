# TODO: Modify this shit so that I don't need a license :D
...
from pyVim.connect import ConnectNoSSL, Disconnect
...
def main():
    ...
    try:
        si = ConnectNoSSL(host=args.host,
                          user=args.user,
                          pwd=args.password,
                          port=int(args.port))
